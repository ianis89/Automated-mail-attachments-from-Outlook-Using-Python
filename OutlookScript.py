...
FOLDER_PATH = r'/yourpath/yourpath/yourpath/yourpath'

email_user = 'yourmail@outlook.com' #input('Email: ')
email_pass = 'yourPassword' #input('Password: ')
context = ssl.SSLContext(ssl.PROTOCOL_SSLv23)
mail = imaplib.IMAP4_SSL("outlook.office365.com",port=993,ssl_context=context)
